  ...
  <div className="mb-4">
    ...
    <input
      ...
      className={`w-full p-3 bg-gray-700/50 border border-gray-600  text-white focus:outline-none placeholder-gray-400 ${
        disabled ? "opacity-50 cursor-not-allowed" : "focus:border-blue-500"
      }`}
      onClick={onClicked}
    />
  </div>
...
const Select = ({ value, onChange, options, label }) => (
  <div className="mb-4">
    ...
    <select
      value={value}
      onChange={(e) => onChange(e.target.value)}
      className="w-full p-3 bg-gray-700/50 border border-gray-600  text-white focus:border-blue-500 focus:outline-none"
    >
      {options.map((option) => (
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-8 flex justify-end">
              <button
                ...
                disabled={saving}
                className="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-semibold  transition-all duration-300 transform hover:scale-105 disabled:opacity-30"
              >
